...
class InterfazCalculadora(Tk):
    ...
    def construir_widget(self):
        ...
        for boton in botones:
            if boton in ["=","*","/","-","+","C","<","%"]:
                ...
                color_fondo=cons.COLOR_BOTONES_NORMALES_NEGRO
    ...
    def boton_cambio_tema(self):
        ...
        self.boton_tema=Button(self,text="modo oscuro",width=13,font=font_icono,bd=cons.color_botenes_especial_ligth,command=lambda:cambio_tema(self,cons))  
        self.boton_tema.grid(row=0,column=0,columnspan=2,padx=0,pydy=0,sticky="nw")        