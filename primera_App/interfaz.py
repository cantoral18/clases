...
class InterfazApp(Tk):
    ...
    def contrubuir_widget(self):
        ...
        #boton nuevo
        self.nuevo=Button(self.cajas_botones,command=lambda:f_nuevo(self),text="Nuevo",bg=COLOR_BOTON,fg="Black",
        relief=FLAT,bd=0,width=20,height=2,font=("Arial",10)).pack(pady=8)
        #boton actualizar
        self.actualizar=Button(self.cajas_botones,command=lambda:f_actualizar(self),text="Actualizar",bg=COLOR_BOTON,fg="Black",
        relief=FLAT,bd=0,width=20,height=2,font=("Arial",10)).pack(pady=8)
        #boton aliminar
        self.eliminar=Button(self.cajas_botones,command=lambda:f_eliminar(self),text="Eliminar",bg=COLOR_BOTON,fg="Black",
        relief=FLAT,bd=0,width=20,height=2,font=("Arial",10)).pack(pady=8)
        #boton cancelar
        self.cancelar=Button(self.cajas_botones,command=lambda:f_limpiar(self),text="Cancelar",bg=COLOR_BOTON,fg="Black",
        relief=FLAT,bd=0,width=20,height=2,font=("Arial",10)).pack(pady=8)
        #fin cajita botones
